                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a href="#"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Welcome to Todo Application
                                </h2>

                                <p class="mt-4 text-sm/relaxed">
                                    To Get Start You Should Register First To The App From Top Right Of The Page, But If
                                    You Have An Account Just Log in.
                                </p>
                            </div>
